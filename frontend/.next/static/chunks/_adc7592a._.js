...
function Home() {
    ...
    const handleAddTodo = ()=>{
        try {
            const res = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$award$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Award$3e$__["Award"];
        } catch (error) {
            console.log(error);
        }
    };
 ...
 //       )}
 //     </div>
_s(Home, "T3MgUkCPqYYSdrhLI5irH09//oA=");
_c = Home;
var _c;
...
//# sourceMappingURL=_adc7592a._.js.map